...
// bundled Kaivo plugin (reads ruleset, imports SDK, etc.). Observed
 ...
 * `/opt/kaivo-opencode-plugin/index.js`. OpenCode's config loader only picks
 * up plugins from:
 ...
 */
const PLUGIN_CONTAINER_PATH = 'file:///opt/kaivo-opencode-plugin/index.js'
