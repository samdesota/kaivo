...
**Steps**
- Port `/Users/sam/d/starch/Starch-app/supabase/functions/_shared/agent-tree-snapshot.ts` into the Cloud Code browser tool layer with minimal semantic changes.
...
**Tests**
- Unit: plugin registers every browser tool when Cloud Code credentials exist.
