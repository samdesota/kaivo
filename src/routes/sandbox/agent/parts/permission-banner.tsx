...
/**
 * Inline card on the tool call that caused the gate. Calls `agent.sessionApprove`
 * / `agent.sessionReject`. The checkbox toggles `always=true` so OpenCode
 * remembers the allowance for this session.
 */
export function PermissionBanner({
  ...
  const approve = trpc.agent.sessionApprove.useMutation()
  const reject = trpc.agent.sessionReject.useMutation()
