...
/**
 * Minimal unified-diff renderer. Takes raw `git diff` output and paints
 * the classic +/-/@@ colors. No third-party dependency; handles one-file
 * and multi-file diffs, and renders the empty case sanely.
 */
...
function splitLines(s: string): Array<{ kind: LineKind; text: string }> {
  ...
  // Trim trailing empty line (common in git output)
