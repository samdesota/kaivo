...
function EntryRow({
  ...
  if (entry.kind === 'directory') {
    ...
    return (
      <>
        <button
          className="flex w-full items-center gap-1 rounded px-2 py-0.5 text-left text-sm text-neutral-200 hover:bg-highlight"
          style={indent}
          onClick={() =>
            setExpanded((prev) => {
  ...
  return (
    <button
      className={
        'flex w-full items-center gap-2 rounded px-2 py-0.5 text-left text-sm hover:bg-highlight ' +
        (isActive ? 'bg-highlight text-neutral-200' : 'text-neutral-300')
      }
      style={indent}
