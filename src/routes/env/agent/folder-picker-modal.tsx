    ...
    <Modal open={open} onClose={onClose} title={title} widthClass="max-w-lg">
      <div className="space-y-3" onKeyDown={onKey}>
        ...
        <input
          ...
          placeholder="Filter…"
          className="w-full rounded border border-neutral-800 bg-neutral-900 px-2 py-1 text-xs text-neutral-100 placeholder-neutral-500 focus:border-neutral-600 focus:outline-none"
        />
