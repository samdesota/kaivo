    ...
    <form onSubmit={onSubmit} className="space-y-3">
      ...
      {draft.source === 'url' ? (
        <input
          ...
          className="w-full rounded border border-neutral-800 bg-neutral-950 px-2 py-1.5 text-sm text-neutral-100 focus:border-brand-500/60 focus:outline-none"
        />
      ...
      <div className="grid grid-cols-2 gap-2">
        <input
          ...
          className="rounded border border-neutral-800 bg-neutral-950 px-2 py-1.5 text-xs text-neutral-200 focus:border-brand-500/60 focus:outline-none"
        />
        <input
          value={draft.ref}
  ...
  return (
    <div className="space-y-2 rounded border border-neutral-700 bg-neutral-900/60 p-2">
      <input
        ...
        placeholder=".env"
        className="w-full rounded border border-neutral-800 bg-neutral-950 px-2 py-1.5 font-mono text-xs text-neutral-100 focus:border-brand-500/60 focus:outline-none"
      />
      <textarea
        value={contents}
        ...
        className="w-full rounded border border-neutral-800 bg-neutral-950 px-2 py-1.5 font-mono text-xs text-neutral-100 focus:border-brand-500/60 focus:outline-none disabled:opacity-60"
      />
      <div className="flex gap-2">
        <button
          onClick={() => void onSave()}
